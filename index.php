...
$servername = "intellibench.ciokufaswewz.eu-central-1.rds.amazonaws.com";
$username = "admin";
$password = "Szmurk91";
...
if ($connected){
    echo "Function is connected to the internet";
    fclose($connected);
}else{
    echo "Function is NOT connected to the internet";
}
*/
